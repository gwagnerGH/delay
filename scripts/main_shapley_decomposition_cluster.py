...
output_folder = "shapley-decomposition-BY2025-fixedlearn-run0-v1"
...
SHAPLEY_DELAYS = list(SUPPORTED_FIXED_DELAY_YEARS)
SHAPLEY_PERIOD_LEN = FIXED_DELAY_PERIOD_LEN
SHAPLEY_EMISSIONS_TIME_STEP = FIXED_DELAY_EMISSIONS_TIME_STEP
SHAPLEY_DAMAGE_FILE_TAG = f"{FIXED_DELAY_DAMAGE_FILE_TAG}_SHAPLEY"
