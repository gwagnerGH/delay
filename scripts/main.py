...
def main():
    ...
    for i in desired_runs:
        ...
        t = TreeModel(decision_times=DEFAULT_DECISION_TIMES, prob_scale=1.0)
        ...
        """
        emit0_year = 2030
        emit_at_0 = float(np.interp(emit0_year,
                                    baseline_emission_model.times,
        ...
        damsim_filename = ''.join(["simulated_damages_df", str(dam_func),
                                   ...
                                   damage_cache_tag(t.decision_times, t.prob_scale)])
        ...
        if optimize:
            ...
            gs_model = GradientSearch(var_nums=t.num_decision_nodes, utility=u, accuracy=5.e-7,
