...
echo "===== EZClimate Backstop Relevance Grid Task ====="
echo "Host: ${HOSTNAME}"
echo "Job: ${JOB_ID:-?}  Task: ${SGE_TASK_ID:-?}"
echo "OUTPUT_FOLDER=${OUTPUT_FOLDER:-paper-backstop-relevance-grid-v1}"
echo "Grid: EIS=${BACKSTOP_GRID_EIS:-15 inclusive values}; RA=${BACKSTOP_GRID_RA:-10 inclusive values}; PRTP=${BACKSTOP_GRID_PRTP:-10 inclusive values}"
echo "BACKSTOP_GRID_BACKSTOP_CAP=${BACKSTOP_GRID_BACKSTOP_CAP:-1.5}"
echo "===================================================="
...
python -u main_backstop_relevance_grid_cluster.py
