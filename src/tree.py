...
class TreeModel(object):
    ...
    base_year : int, optional
        calendar year corresponding to decision time 0
    ...
    def __init__(self, decision_times, prob_scale=1.0, base_year=DEFAULT_BASE_YEAR):
    ...
    def calendar_years(self):
        """ndarray: decision times converted to calendar years."""

        return self.base_year + self.decision_times
